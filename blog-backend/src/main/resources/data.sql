...
INSERT INTO post (title, body, user_id, created_by, created_date, last_modified_by, last_modified_date) VALUES
 ...
 , '1', 'keumtae.kim', now()+8, 'keumtae.kim', now()+10);
 ...
 , '1', 'keumtae.kim', now()+8, 'keumtae.kim', now()+9);
...
INSERT INTO post (title, body, user_id, created_by, created_date, last_modified_by, last_modified_date) VALUES
 ...
 , '1', 'keumtae.kim', now()+8, 'keumtae.kim', now()+8);
...
INSERT INTO post (title, body, user_id, created_by, created_date, last_modified_by, last_modified_date) VALUES
 ...
 , '1', 'keumtae.kim', now()+7, 'keumtae.kim', now()+7);
...
INSERT INTO post (title, body, user_id, created_by, created_date, last_modified_by, last_modified_date) VALUES
 ...
 , '1', 'keumtae.kim', now()+6, 'keumtae.kim', now()+6);